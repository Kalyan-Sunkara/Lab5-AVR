...
tests = [ {'description': 'Initial State => PortC = 0x07',
    ...
    {'description': 'double adding => PortC = 0x09',
    ...
    {'description': 'double adding + reset => PortC = 0x09',
    'steps': [ {'inputs': [('PINA',0x0E)], 'iterations': 5 },
                {'inputs': [('PINA',0x0E)], 'iterations': 5 },
                {'inputs': [('PINA',0x0F)], 'iterations': 5 },
                {'inputs': [('PINA',0x0E)], 'iterations': 5 },
    ...
    {'description': '9-1 + reset => PortC = 0x00',
    'steps': [ #{'inputs': [('PINA',0x01)], 'iterations': 5 },
                ...
                #{'inputs': [('PINA',0x00)], 'iterations': 5 },
                #{'inputs': [('PINA',0x01)], 'iterations': 5 },
                {'inputs': [('PINA',0x0D)], 'iterations': 5 },
		{'inputs': [('PINA',0x0C)], 'iterations': 5 },
        ],
    'expected': [('PORTC',0x00)],
    },
    ]
